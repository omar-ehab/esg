...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row justify-content-between">
            <div class="col-md-10">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Equipment /</span> All
                    Equipment
                </h4>
            </div>
        ...
        <div class="card">
            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-hover">
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="text-center">There is no equipment!</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteConfirmationLabel">Delete Equipment !</h5>
                    <button
                        type="button"
                        class="btn-close"
                ...
                <form action="" method="POST">
                    @csrf
                    @method('delete')
                    <div class="modal-body">are you sure you want to delete equipment?</div>
