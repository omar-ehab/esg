                    ...
                    <div class="container" id="memberapplicationcontainer2" id="family2">
                        ...
                        <div class="row" id="family22">
                            <div class="col-md-12 animate-box" style="opacity: 1;">
                                ...
                                <div class="columnmember" id="responsiveid">
                                    <div class="row form-group member">
                                        <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        function addRow() {
            ...
            var tr =
                ...
                '<div class="columnmember " id="responsiveid"><div class="row form-group member"><div class="col-md-12"><input class="newtop" type="file" name="NID_image_family[' + i + ']" /></div></div></div>' +
                ...
                '<div class="columnmember2"> <div class="row form-group member topbtns remove"><a onclick="addRow()" type="button" class="btn btn-primary btn-lg btn-learn memberbtn add" id="responsiveright">+</a><a onclick="removeItem(this)" type="button" class="btn btn-primary btn-lg btn-learn memberbtn" style="background-color: #dc2828;border: 2px solid #881717;">x</a></div></div>' +
                '</div>';
            $('#family22').append(tr);
        }
