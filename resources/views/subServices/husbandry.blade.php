                ...
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    <div class="shipping-service wow fadeIn">
                        ...
                        <div class="shipping-service-details industrypage">
                            ...
                            <!-- <p><?php //secho  nl2br($husbandry->husbandry_desc_paragraph)  ?> </p> -->

                            <p> {!!html_entity_decode( $husbandry->husbandry_desc_paragraph)!!} </p>

                            <br>

                            <h4>{{ $husbandry->husbandry_desc_title2 }}</h4>

                            <p> {!!html_entity_decode( $husbandry->husbandry_desc_list)!!} </p>
                                        ...
                                        @foreach($images as $image)
                                            <div class="card">
                                                <div class="card-image">
                                                    <a href="{{asset('/serviceImages')}}/{{ $image->husbandry_image_img  }}"
                                                       data-fancybox="gallery">
                                                        <img
                                                            src="{{asset('/serviceImages')}}/{{ $image->husbandry_image_img  }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                            </div>
