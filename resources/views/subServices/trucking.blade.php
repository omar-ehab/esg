                ...
                <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
                    ...
                    <div class="sc-services-details trucking d-flex align-items-center wow fadeIn">
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                            ...
                            @foreach($truckingServices as $service)
                                <h4>{{ $service->trucking_title }}</h4>
                                @if( $service->trucking_desc_paragraph)
                                    <p> {!!html_entity_decode( $service->trucking_desc_paragraph)!!} </p>
                                @endif

                                @if( $service->trucking_desc_list)
                                    <p> {!!html_entity_decode( $service->trucking_desc_list)!!} </p>
                                @endif
                                <hr>
                        ...
                        <div class="col-md-5 col-lg-5 col-sm-12 col-xs-12">
                            <img class=" mx-auto mt-auto mb-auto trucking-img-new"
                                 src="{{asset('/images')}}/{{ $truckingImage->main_img  }}" alt="">
                            <img class=" mx-auto mt-auto mb-auto"
                                 src="{{asset('/images')}}/{{ $truckingImage2->main_img  }}" alt="">
                        </div>

                        <!--
                    <div class="col-md-5 col-lg-5 col-sm-12 col-xs-12 trucking-img-new">
                        <img src="{{asset('/images')}}/{{ $truckingImage2->main_img  }}" alt="">
                    </div>
-->
                    </div>
