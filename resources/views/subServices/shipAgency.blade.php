            ...
            <div class="row">
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    <div class="shipping-service wow fadeIn">
                        <!--
                    <div class="blog-image industrypage">
                        <img src="{{asset('/serviceImages')}}/{{ $shipAgencyService->ship_agency_img  }}" alt="">
                    </div>
-->
                        <div class="shipping-service-details industrypage">

                            <!--                            <h2><a href="">Project Cargo</a></h2>-->
                            <p><?php echo nl2br($shipAgencyService->ship_agency_desc_paragraph) ?> </p>

                            <br>

                            <h4>{{ $shipAgencyService->ship_agency_desc_title2 }}</h4>


                            <p> {!!html_entity_decode( $shipAgencyService->ship_agency_desc_list)!!} </p>
                                        ...
                                        @foreach($images as $image)
                                            <div class="card">
                                                <div class="card-image">
                                                    <a href="{{asset('/serviceImages')}}/{{ $image->ship_agency_image_img  }}"
                                                       data-fancybox="gallery">
                                                        <img
                                                            src="{{asset('/serviceImages')}}/{{ $image->ship_agency_image_img  }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                            </div>
