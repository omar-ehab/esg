        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12 ">
                    ...
                    @foreach($seaFreights as $i=>$service)
                        <div class="tab-content sea-freight-content">

                            <div class=" d-flex align-items-center" id="Service-{{$i}}">

                                <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                                    <h3>{{$service->sea_freight_service_name}}</h3>

                                    <div class="sea-freigt-details">


                                        <p> {!!html_entity_decode( $service->sea_freight_desc_paragraph)!!} </p>

                                        <br>

                                        <h4>{{ $service->sea_freight_desc_title2}}</h4>

                                        <p> {!!html_entity_decode( $service->sea_freight_desc_list)!!} </p>
                                ...
                                <div class="col-md-5 col-lg-5 col-sm-12 col-xs-12">
                                    <div class="sea-freigt-details">
                                        <img src="{{asset('/serviceImages')}}/{{ $service->sea_freight_img  }}" alt="">
                                    </div>
                                </div>
                            </div>
