    ...
    <section class="main-industries">
        <div class="container mb-5">
            <div class="text-left industries-section mt-5">
                <h1>{{ $suezCanal->service_name }}</h1>

                <p> {!!html_entity_decode( $suezCanal->service_description)!!}</p>

            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="{{ route('scService') }}">
                        <div class="box-industries">
                            <div class="our-services-industries">
                                <div class="icon"><img src="{{asset('/images')}}/{{ $scServiceMain->main_img  }}"></div>
                                <div class="text">
                                    <h4>SC Service</h4>
                                    <?php
                                    $descsMain = explode(" ", strip_tags($scServiceMain->main_desc));
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="{{ route('scConvoy') }}">
                        <div class="box-industries">
                            <div class="our-services-industries">
                                <div class="icon"><img src="{{asset('/images')}}/{{ $scConvoyMain->main_img  }}"></div>
                                <div class="text">
                                    <h4>SC Convoy</h4>

                                    <?php
                                    $descsMain2 = explode(" ", strip_tags($scConvoyMain->main_desc));
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="{{ route('suezCanalCalculator') }}">
                        <div class="box-industries">
                            <div class="our-services-industries">
                                <div class="icon"><img src="{{asset('/images')}}/{{ $scCalculatorMain->main_img  }}">
                                </div>
                                <div class="text">
                                    <h4>SC Toll Calculator</h4>

                                    <?php
                                    $descsMain3 = explode(" ", strip_tags($scCalculatorMain->main_desc));
